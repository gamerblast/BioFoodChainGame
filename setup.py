...
class BuildExe:
    def __init__(self):
        ...
        #Version of program
        self.project_version = "4.20"
 
        #License of the program
        self.license = "MyApps License"
 
        #Auhor of program
        self.author_name = "Ohm Nabar and Jeemin Park"
        self.author_email = "ohmnab@bergen.org and jeepar@bergen.org"
        self.copyright = "Copyright (c) 420 Blaze."
 
        #Description
        self.project_description = "getrektm8"
        ...
        self.extra_modules = ["random", "pygame._view"]
